...
struct PoseScorer {
    ...
    static let minimalBaseScore: Double = 40.0

    // MARK: - 理想范围

    /// 身体前倾：理想 10°~25°
    static let leanIdealMin = 10.0
    static let leanIdealMax = 25.0
    /// 每偏离 5° 扣 10 分
    static let leanPenaltyPer5Deg = 10.0

    /// 膝盖弯曲：理想 100°~140°
    static let kneeIdealMin = 100.0
    static let kneeIdealMax = 140.0
    /// 每偏离 10° 扣 8 分
    static let kneePenaltyPer10Deg = 8.0

    /// 小腿倾斜：0°=0分, 80°=100分（越高越好）
    static let calfMaxScoreAngle = 80.0

    /// 重心评分
    static let gravityScores: [String: Double] = [
        "低": 90,
        "中": 60,
        "高": 30
    ]
    ...
    /// 对称性：每偏离 5° 扣 10 分
    static let symmetryPenaltyPer5Deg = 10.0

    // MARK: - 等级划分

    static let levelThresholds: [(range: Range<Double>, level: String)] = [
        (85..<101, "专业"),
        (75..<85,  "高级"),
        (60..<75,  "中级"),
        (0..<60,   "初级")
    ...
    func score(pose: BodyPoseData) -> PoseScore? {
